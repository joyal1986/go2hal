...
func MakeHandler(service Service, logger kitlog.Logger, ml machineLearning.Service) http.Handler {
	...
	alertGroupHandler := kithttp.NewServer(makeAlertGroupHandler(service), gokit.DecodeString, gokit.EncodeResponse, opts...)
	r := mux.NewRouter()
	...
	r.Handle("/alert/group", alertGroupHandler).Methods("POST")
	return r
}
